...
"""
    ...
    await trio.run_process("xdg-mime default guardata.desktop x-scheme-handler/parsec".split())
...
def main(**kwargs):
    ...
    variables so the upcoming guardata commands point to the test environment:
