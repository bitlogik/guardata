...
from backendService.config import BaseBlockStoreConfig
...
def blockstore_factory(
    ...
    if config.type == "MOCKED":
        from backendService.memory import MemoryBlockStoreComponent

        return MemoryBlockStoreComponent()

    elif config.type == "POSTGRESQL":
        from backendService.postgresql import PGBlockStoreComponent
        ...
        try:
            from backendService.s3_blockstore import S3BlockStoreComponent
        ...
        try:
            from backendService.swift_blockstore import SwiftBlockStoreComponent
        ...
        from backendService.raid1_blockstore import RAID1BlockStoreComponent
        ...
        from backendService.raid0_blockstore import RAID0BlockStoreComponent
        ...
        from backendService.raid5_blockstore import RAID5BlockStoreComponent
